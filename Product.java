...
public class Product
{
	...
	public static boolean validCategory(String category) // check if valid category
	{
		if(category.equalsIgnoreCase("BOOKS")) // check if category string equals any of the categories
			return true;
